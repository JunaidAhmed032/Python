...
def data(imports, exports, year):
    x = 0
    table = PrettyTable(["YEAR", "EXPORTS", "IMPORTS"])
    while x < len(year):
        table.add_row([year[x], exports[x], imports[x]])
        x = x + 1
...
def graphical_analysis():
    ...
    time_series(yearly_imports, imports_label, yy)
...
def mean(imports, exports):
    exports_mean = statistics.mean(exports)
    imports_mean = statistics.mean(imports)
    print ("Average Exports of Pakistan in Imran Khan's Tenure: ", exports_mean)
    print("Average imports of Pakistan in Imran Khan's Tenure: ", imports_mean)
    if exports_mean > imports_mean:
        print ("\t\t\tPakistan is in Profit")
    else:
        print("\t\t\tPakistan is in Loss")
    print("\t\t\t====================================================================================================")


def mode(imports, exports):
    exports_mode = statistics.mode(exports)
    imports_mode = statistics.mode(imports)
    print("Pakistan has made imports of " + str(imports_mode) + " mostly in this session")
    print("Pakistan has made exports of " + str(imports_mode) + " mostly in this session")
    if exports_mode > imports_mode:
        print("Pakistan has made more exports than imports of this category\n\t\t\t Pakistan is in Profit")
    else:
        print("Pakistan has made more imports than exports of this category\n\t\t\t Pakistan is in Loss")
    print("\t\t\t====================================================================================================")
...
if __name__ == '__main__':
    ...
    table = PrettyTable(["YEAR", "EaXPORTS", "IMPORTS","BALANCE OF TRADE", "PROFIT/LOSS"])
    ...
    mean(imports21, exports21)
    mode(imports21, exports21)
    data(imports21, exports21, xx)
